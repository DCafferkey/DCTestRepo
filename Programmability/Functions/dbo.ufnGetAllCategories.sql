...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Table value function returning every product category and its parent, if applicable.', 'SCHEMA', N'dbo', 'FUNCTION', N'ufnGetAllCategories'
GO